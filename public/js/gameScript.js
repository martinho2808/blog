...
window.onload = function() {
    $("#ol").html(`<center><p style="font-size:18px;">Click one of the following mode to start the game.</p><button onclick="start(3, 4)">3 x 4</button> <button onclick="start(4, 4)" style="w">4 x 4</button><button onclick="start(4, 5)">4 x 5</button></center>`);
}
